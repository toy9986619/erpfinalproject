...
<body>
	...
	<script type="text/javascript">
		...
		function deleteAdmin(id){
			...
			$(deleteHTML).appendTo("#adminEditSite");
			...
			$yesButton.text("確定");
			$yesButton.appendTo("#adminEditSite");

			var fixstr = "&nbsp;&nbsp;";
			$("#adminEditSite").append(fixstr);
			...
			$noButton.text("取消");
			$noButton.appendTo("#adminEditSite");
